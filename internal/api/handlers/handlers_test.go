...
func TestStubHandler_ListSources(t *testing.T) {
...
func TestStubHandler_ListPipelines(t *testing.T) {
	handler := NewStubHandler()

	router := gin.New()
	router.GET("/pipelines", handler.ListPipelines)
...
func TestStubHandler_ListDestinations(t *testing.T) {
	handler := NewStubHandler()

	router := gin.New()
	router.GET("/destinations", handler.ListDestinations)
